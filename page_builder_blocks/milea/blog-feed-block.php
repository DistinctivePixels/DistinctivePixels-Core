...
class Widget_DistinctivePixels_Blog_Block extends Widget_Base {
	
	//Return Class Name
	public function get_name() {
		return 'distinctivepixels-blog-block';
	}
	...
	protected function render() {
		...
		$wp_query->{"is_elementor_blog"} 	=  'true';	
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_DistinctivePixels_Blog_Block() );