(function() {
    tinymce.create('tinymce.plugins.DTPortfolio', {
        ...
        getInfo : function() {
            return {
                    ...
                    authorurl : 'http://www.distinctivepixels.io',
                    infourl : 'http://www.distinctivepixels.io',
                    version : "0.1"
            };
        }
    });
    ...
    // Register plugin
    tinymce.PluginManager.add('distinctivepixels_core_shortcode', tinymce.plugins.DTPortfolio);
